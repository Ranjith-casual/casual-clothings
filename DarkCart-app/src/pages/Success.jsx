  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <div className='flex items-center justify-center p-4'>
        <div className='w-full max-w-md bg-white p-6 rounded-lg shadow-xl border border-gray-200 flex flex-col gap-6 items-center justify-center mt-12'>
      ...
      <CartCategoryProducts title="Thanks For Your Purchase! You Might Also Like" limit={6} />
      <div className="py-4"></div>
      <RandomCategoryProducts title="Discover More" limit={6} />
    </div>
  )
}
