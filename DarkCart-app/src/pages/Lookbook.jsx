      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-black/5 rounded-lg p-6 md:p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-5">
              <div className="flex items-center mb-4">
                <div className="rounded-full theme-bg-gray p-3 mr-3">
                  <svg className="w-6 h-6 theme-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
