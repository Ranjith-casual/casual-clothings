                        ...
                        <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[95vh] overflow-hidden flex flex-col">
                            ...
                            <div className="flex justify-between items-start p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
                                <div className="flex-1 min-w-0 pr-4">
                                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900 leading-tight">Confirm Return Request</h3>
                                </div>
                                <button
                            ...
                            <div className="flex-1 overflow-y-auto p-4 sm:p-6 pt-0">
                                <div className="space-y-4 sm:space-y-6">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
                                        <h4 className="font-medium text-blue-900 mb-2 text-sm sm:text-base">Return Summary</h4>
                                    ...
                                    <div className="space-y-2 sm:space-y-3">
                                        {Object.keys(selectedItems)
                                            ...
                                            .map(itemKey => {
                                                ...
                                                return (
                                                    <div key={itemKey} className="border border-gray-200 rounded-lg p-3 sm:p-4">
                            ...
                            <div className="border-t border-gray-200 p-4 sm:p-6 flex-shrink-0">
                                <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button
                                        ...
                                        disabled={submitting}
                                        className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors font-medium flex items-center justify-center gap-2 text-sm sm:text-base"
                                    >
                                        {submitting ? (
                                            <>
